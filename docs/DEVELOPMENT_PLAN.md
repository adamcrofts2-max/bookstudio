...
## Working Rules
Commit after every milestone. Test every feature before continuing. Never overwrite
user content. Never require users to re-import manuscripts or illustrations after
design changes. Keep content, themes and layout completely independent. Document every
architectural decision. Refactor when necessary instead of accumulating technical debt.

## Definition of Version 1 Complete
A user can create a project, import a manuscript, import illustrations, choose a theme,
automatically generate a professional layout, make minor visual adjustments, and export
a print-ready PDF. Only then does development move to advanced AI-assisted features.
