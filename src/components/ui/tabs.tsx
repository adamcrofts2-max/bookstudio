...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center whitespace-nowrap rounded-[calc(var(--radius-button)_-_4px)] px-3 py-1 text-sm font-medium transition-colors duration-150',
